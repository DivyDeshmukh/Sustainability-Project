...
function Login() {
  ...
  return (
      ...
      <div class="loginForm m-1 py-0 flex flex-col justify-center sm:py-12">
        <div class="login w-full relative py-3 sm:max-w-xl sm:mx-auto">
          <div class="login absolute inset-0 bg-gradient-to-r from-green-300 to-green-600 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl"></div>
          <div class="login relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
